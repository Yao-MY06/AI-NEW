...
const STOP = new Set([
  ...
  'before', 'your', 'you', 'their', 'this', 'that', 'about', 'into', 'over', 'will', 'can',
  'may', 'not', 'but', 'has', 'have', 'was', 'were', 'more', 'than', 'them', 'they', 'all',
  'her', 'his', 'our', 'who', 'now', 'get', 'out', 'up', 'off', 'amid', 'among', 'between',
]);
